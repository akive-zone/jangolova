...
const schemaURL = new URL('protocol/pacman/v1/protocol.schema.json', root);
const goURL = new URL('internal/pacmanprotocol/generated_v1.go', root);

const schemaSource = await readFile(schemaURL, 'utf8');
const schema = JSON.parse(schemaSource);
const digest = createHash('sha256').update(schemaSource).digest('hex');

const go = `// Code generated from protocol/pacman/v1/protocol.schema.json; DO NOT EDIT.
